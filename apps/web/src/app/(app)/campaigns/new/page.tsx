  ...
  return (
    <div className="p-8 max-w-3xl">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Send a job requirement to your contacts</p>
      </div>

      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <Card>
          <CardHeader><CardTitle>Requirement Details</CardTitle></CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label>Requirement Name (internal)</Label>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Choose who will receive this requirement</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
